package fr.application.appender;
...
public class TextAreaAppendExample {
	...
	protected static void setupLog4JAppender(JTextArea jTextArea) {
		...
		logProperties.put("log4j.appender.TEXTAREA", "fr.application.appender.TextAreaAppender");  // Our custom appender
	...
	protected static void setupJdkLoggerHandler(JTextArea logJTextArea) {
		...
		buf.append("handlers = fr.application.appender.TextAreaHandler, java.util.logging.ConsoleHandler"); // A default handler and our custom handler
		buf.append("\n");
		buf.append(".level = INFO"); // Set the default logging level see: C:\software\sun\jdk141_05\docs\api\index.html
		buf.append("\n");
		buf.append("fr.application.appender.TextAreaHandler.level = INFO"); // Custom Handler logging level
		buf.append("\n");
